...
namespace TangApplication.Pages
{
    ...
    public sealed partial class EventsListPage : Page
    {
        ...
        async void LoadEvents(string todate = "", string fromdate = "", string province = "", string region = "", string search = "",
            bool isfilterClick=false)
        {
            ...
            string url = "http://api.faitango.it/tango.php?type=event&lang=" + systemLanguage + "";
...
"ms-appx:///Assets/filter-icon.png", UriKind.Absolute));
                        ...
                        lstEvents.ItemsSource = _result.data;
        ...
        private void lstEvents_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (e.AddedItems.Count > 0)
            {
                ...
                if (data != null)
                {
                    ...
                    EventDetailPage._newData = _Data;
                    Frame.Navigate(typeof(EventDetailPage ), lstRecords);
                }
            }
        ...
        private void btnOk_Click(object sender, RoutedEventArgs e)
        {
            ...
            LoadEvents(dtpTo.Date.ToString("yyyy-MM-dd"), dtpFrom.Date.ToString("yyyy-MM-dd"),
