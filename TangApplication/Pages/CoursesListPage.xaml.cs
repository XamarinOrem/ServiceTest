...
namespace TangApplication.Pages
{
    ...
    public sealed partial class CoursesListPage : Page
    {
        ...
        private void lstCourses_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (e.AddedItems.Count > 0)
            {
                ...
                if (data != null)
                {
                    ...
                    CourseDetailPage._newData = _Data;
                    Frame.Navigate(typeof(CourseDetailPage), lstRecords);
                }
            }
        }
        ...
        async void LoadCourses(string todate = "", string fromdate = "", string province = "", string region = "", string search = "",
            bool isfilterClick=false )
        {
            ...
            string url = "http://api.faitango.it/tango.php?type=corsi&lang=" + systemLanguage + "";
...
"ms-appx:///Assets/filter-icon.png", UriKind.Absolute));
                        ...
                        lstCourses.ItemsSource = _result.data;
        ...
        private void btnOk_Click(object sender, RoutedEventArgs e)
        {
            ...
            LoadCourses (dtpTo.Date.ToString("yyyy-MM-dd"), dtpFrom.Date.ToString("yyyy-MM-dd"),
